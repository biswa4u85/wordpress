...
if(!class_exists('webnus_importer_class'))
{
	class webnus_importer_class{
		...
		//	add_menu_page( 'Importer Plus', 'Importer +', 'manage_options', 'importer_plus', array($this, 'generate_importer_page'),null , 300 );
		}
							...
							<tr valign="middle">
								...
								<td>
									<select name="webnus_import_option" id="webnus_import_option">
										<option value="all">Importer All Demo Data</option>									
									</select>
