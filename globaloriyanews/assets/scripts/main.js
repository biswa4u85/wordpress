...
function(position) {
  ...
  return this._trimAlignValue(valueMouse);
      ...
      var vpsnameval = new Array('Official', 'Personal'); //VPS plan names
      var memoryval = new Array('<i class="fa fa-inr"></i> 220', '<i class="fa fa-inr"></i> 200'); //Memory array per plan
      var cpuval = new Array('<i class="fa fa-inr"></i> 170', '<i class="fa fa-inr"></i> 150'); //CPU array per plan
      var diskspaceval = new Array('<i class="fa fa-inr"></i> 320', '<i class="fa fa-inr"></i> 300'); //Disk Space array per plan

      var priceval = new Array('50', '99'); //Price array per plan
      var urlval = new Array('1', '2'); //WHMCS pid array per plan

      var finalurl = '#'; //Update "whmcs.audemedia.com" with your WHMCS/billing system installation URL
