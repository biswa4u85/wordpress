...
function setup_framework_options() {
    ...
    $sections[] = array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'webnus_header_address',
                'type' => 'text',
                'title' => __('Address', WEBNUS_TEXT_DOMAIN)
            ),

            array(
                'id' => 'webnus_header_parking',
                'type' => 'text',
                'title' => __('Parking Text', WEBNUS_TEXT_DOMAIN),
            ),
            ...
            array(
                'id' => 'webnus_header_mail',
                'type' => 'text',
                'title' => __('Email Link', WEBNUS_TEXT_DOMAIN),
            ),
	...
	$sections[] = array(
        ...
        'title' => __('Service Info', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

            array(
                'id' => 'webnus_testimonialss_title',
                'type' => 'text',
                'title' => __('Service Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            ...
            array(
                ...
                'type' => 'text',
                'title' => __('Service Description', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
	...
	$sections[] = array(
        'icon' => NHP_OPTIONS_URL . 'img/admin-general.png',
        'title' => __('Team Info', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

            array(
                'id' => 'webnus_blog_title',
                'type' => 'text',
                'title' => __('Team Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_blog_desc',
                'type' => 'text',
                'title' => __('Team Description', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
