...
if (!class_exists('webnus_options')) {
	class webnus_options {
		...
		function webnus_header_address() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_header_address']) ? $thm_options['webnus_header_address'] : null;
		}

		function webnus_header_parking() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_header_parking']) ? $thm_options['webnus_header_parking'] : null;
		}
		...
		function webnus_header_mail() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_header_mail']) ? $thm_options['webnus_header_mail'] : null;
		}
