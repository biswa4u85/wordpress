...
if($thm_options['webnus_menu_selected_border_color'])
	echo "#header.box-menu .nav-wrap2 #nav > li.current,#header.box-menu .nav-wrap2 #nav > li:hover,#wrap #nav > li.current:after,#header.box-menu .nav-wrap2 #nav > li ul {border-color:{$thm_options['webnus_menu_selected_border_color']};}\n\n";
