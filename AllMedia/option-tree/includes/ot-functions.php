...
function ibubble_add_admin_menu(){
  add_menu_page("Admin Menu",  'Theme Options', TEMPL_ACCESS_USER, 'ot-theme-options', '', get_bloginfo('template_url').'/assets/images/fav.png', '2'); // title of new sidebar
}
// Filters the options.php to add the minimum user capabilities.
//add_filter( 'option_page_capability_' . ot_options_id(), create_function( '$caps', "return '$caps';" ), 999 );
add_action('templ_admin_menu', 'ibubble_add_admin_menu');
