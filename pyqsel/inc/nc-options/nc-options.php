...
function setup_framework_options() {
    ...
    $sections[] = array(
        ...
        'fields' => array(
			...
			array(
                'id' => 'webnus_header_phone_text',
                'type' => 'text',
                'title' => __('Phone Number Text', WEBNUS_TEXT_DOMAIN),
                'std' => 'Call Us Today for FREE'
            ),

            array(
                'id' => 'webnus_header_phone',
                'type' => 'text',
                'title' => __('Phone Number', WEBNUS_TEXT_DOMAIN),
                'std' => '+01 830 214 524'
            ),
            array(
                'id' => 'webnus_header_quote_text',
                'type' => 'text',
                'title' => __('Quote Text', WEBNUS_TEXT_DOMAIN),
                'std' => 'GET A QUOTE'
            ),

            array(
                'id' => 'webnus_header_quote',
                'type' => 'text',
                'title' => __('Quote Link', WEBNUS_TEXT_DOMAIN),
	...
	$sections[] = array(
        ...
        'fields' => array(
			...
			array(
                'id' => 'webnus_banner_youtube',
                'type' => 'text',
                'title' => __('Banner Youtube Embed Id', WEBNUS_TEXT_DOMAIN),
                'std' => '8OBfr46Y0cQ',
                'desc' => __('Like this (8OBfr46Y0cQ)', WEBNUS_TEXT_DOMAIN),
            ),
            array(
                'id' => 'webnus_banner_form',
                'type' => 'text',
                'title' => __('Banner Form', WEBNUS_TEXT_DOMAIN),
                'std' => '[contact-form-7 id="6" title="Contact form"]'
            ),
	...
	$sections[] = array(
        'icon' => NHP_OPTIONS_URL . 'img/admin-general.png',
        'title' => __('Home Marketing', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

			array(
                'id' => 'webnus_marketing_title',
                'type' => 'text',
                'title' => __('Marketing Title', WEBNUS_TEXT_DOMAIN)
            ),
            array(
                'id' => 'webnus_marketing_sub_title',
                'type' => 'text',
                'title' => __('Marketing Sub Title', WEBNUS_TEXT_DOMAIN)
            ),
            array(
                'id' => 'webnus_marketing_desc',
                'type' => 'text',
                'title' => __('Marketing Description', WEBNUS_TEXT_DOMAIN)
            ),
	...
	$sections[] = array(
        'icon' => NHP_OPTIONS_URL . 'img/admin-general.png',
        'title' => __('Home Credit Card', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

            array(
                'id' => 'webnus_credit_card_title',
                'type' => 'text',
                'title' => __('Credit Card Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_credit_card_subtitle',
                'type' => 'text',
                'title' => __('Credit Card Sub Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_credit_card_desc',
                'type' => 'text',
                'title' => __('Credit Card Description', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_credit_card_img',
                'type' => 'upload',
                'title' => __('Credit Card Image', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
	...
	$sections[] = array(
        'icon' => NHP_OPTIONS_URL . 'img/admin-general.png',
        'title' => __('Home Business', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

			array(
                'id' => 'webnus_new_business_title',
                'type' => 'text',
                'title' => __('New Business Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_new_business_subtitle',
                'type' => 'text',
                'title' => __('New Business Sub Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_new_business_desc',
                'type' => 'text',
                'title' => __('New Business Description', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_new_business_img',
                'type' => 'upload',
                'title' => __('New Business Image', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
	...
	$sections[] = array(
        'icon' => NHP_OPTIONS_URL . 'img/admin-general.png',
        'title' => __('Testimonials Info', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

            array(
                'id' => 'webnus_testimonialss_title',
                'type' => 'text',
                'title' => __('Testimonials Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),

            array(
                'id' => 'webnus_testimonialsss_desc',
                'type' => 'text',
                'title' => __('Testimonials Description', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_testimonialss_long_desc',
                'type' => 'text',
                'title' => __('Testimonials Comments', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
	...
	$sections[] = array(
        'icon' => NHP_OPTIONS_URL . 'img/admin-general.png',
        'title' => __('Blog Info', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

			array(
                'id' => 'webnus_blog_status',
                'type' => 'button_set',
                'options' => array('0' => 'Off','1' => 'On'),
                'title' => __('Blog On/Off', WEBNUS_TEXT_DOMAIN),
                'std' => '1'
            ),
            array(
                'id' => 'webnus_blog_title',
                'type' => 'text',
                'title' => __('Blog Title', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
            array(
                'id' => 'webnus_blog_desc',
                'type' => 'text',
                'title' => __('Blog Description', WEBNUS_TEXT_DOMAIN),
                'std' => ''
            ),
   ...
   /*
    ...
    $sections[] = array(
        ...
        'title' => __('Bottom Options', WEBNUS_TEXT_DOMAIN),
        'desc' => __('<p class="description">Customize Bottom</p>', WEBNUS_TEXT_DOMAIN),
        'fields' => array(

            array(
                'id' => 'webnus_bottom_quote_title',
                'type' => 'text',
                'title' => __('Free Quote Title', WEBNUS_TEXT_DOMAIN),

            ),
            array(
                'id' => 'webnus_bottom_quote_desc',
                'type' => 'text',
                'title' => __('Free Quote Description', WEBNUS_TEXT_DOMAIN),

            ),
            array(
                'id' => 'webnus_bottom_quote_link_text',
                'type' => 'text',
                'title' => __('Free Quote Link Title', WEBNUS_TEXT_DOMAIN),

            ),
            array(
                'id' => 'webnus_bottom_quote_link',
                'type' => 'text',
                'title' => __('Free Quote Link', WEBNUS_TEXT_DOMAIN),
